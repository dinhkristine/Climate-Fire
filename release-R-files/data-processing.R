...
# For our case, we store data in a data/ folder. 
# However, the all the fire data is too large to push to github, we link the public wild fire data here 
# Original one dataset https://www.fs.usda.gov/rds/archive/catalog/RDS-2013-0009.4
# 7 split dataset in smaller size: https://github.com/BuzzFeedNews/2018-07-wildfire-trends/tree/master/data/us_fires 

## Use for loop to run all 7 dataset and bind them together
